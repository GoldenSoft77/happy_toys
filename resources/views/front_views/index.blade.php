            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-slide-item swiper-slide">
                    ...
                    <div class="hero-slide-bg">
                        <img src="{{ asset($slide->img) }}" alt="Slider Image" />
                    </div>
                    <div class="container">
                                ...
                                <div class="swiper-slide">
                                    <div class="single-product-banner" data-aos="fade-up" data-aos-delay="200">
                                        <div class="banner-img">
                                            <a href="{{ url('/category/'.$category->id) }}"><img src="{{ $category->img }}" alt="صورة التصنيف"></a>
                                        </div>
                                            ...
                                            <div class="thumb">
                                                <a href="{{ url('/product/'.$item->id) }}" class="image">
                                                    ...
                                                    @php 
                                                        $j = 1; 
                                                    @endphp
                                                    <img class="fit-image" src="{{ asset($img->img) }}" alt="صورة المنتج" />
                                                    @endif
                                                    @endforeach
                                                </a>
                                                ...
                                                <span class="badges">
                                                    <span class="sale">
                                                    - {{ (100 * ($item->price - $item->new_price)) / $item->price }} %
                                                    </span>
                                                </span>
                                                @endif
                                                <div class="actions">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="banner" data-aos="fade-up" data-aos-delay="400">
                        <a href="{{ url('/products') }}"><img src="assets/images/slide2.jpg" alt="مساحة إعلانية" /></a>
                    </div>
                </div>
                <!-- Banner End -->
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide single-brand-logo">
                                        <a><img src="{{ asset('assets/images/brand-logo/1.png') }}" alt="Brand Logo"></a>
                                    </div>
                                    <!-- Single Brand Logo End -->

                                    <!-- Single Brand Logo Start -->
                                    <div class="swiper-slide single-brand-logo">
                                        <a><img src="{{ asset('assets/images/brand-logo/2.png') }}" alt="Brand Logo"></a>
                                    </div>
                                    <!-- Single Brand Logo End -->

                                    <!-- Single Brand Logo Start -->
                                    <div class="swiper-slide single-brand-logo">
                                        <a><img src="{{ asset('assets/images/brand-logo/3.png') }}" alt="Brand Logo"></a>
                                    </div>
                                    <!-- Single Brand Logo End -->

                                    <!-- Single Brand Logo Start -->
                                    <div class="swiper-slide single-brand-logo">
                                        <a><img src="{{ asset('assets/images/brand-logo/4.png') }}" alt="Brand Logo"></a>
                                    </div>
                                    <!-- Single Brand Logo End -->

                                    <!-- Single Brand Logo Start -->
                                    <div class="swiper-slide single-brand-logo">
                                        <a><img src="{{ asset('assets/images/brand-logo/5.png') }}" alt="Brand Logo"></a>
                                    </div>
                                    <!-- Single Brand Logo End -->

                                    <!-- Single Brand Logo Start -->
                                    <div class="swiper-slide single-brand-logo">
                                        <a><img src="{{ asset('assets/images/brand-logo/6.png') }}" alt="Brand Logo"></a>
                                    </div>
                                    <!-- Single Brand Logo End -->
